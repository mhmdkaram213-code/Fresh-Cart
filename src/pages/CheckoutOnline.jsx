...
export default function CheckoutOnline() {
  ...
  function handleSelectAddress(address) {
    ...
    setForm({ details: address.details, phone: address.phone, city: address.city })
    setErrors({})
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data } = await axios.post(
        `${BASE}/orders/checkout-session/${cartId}?url=http://localhost:5173`,
      ...
      setApiError(err.response?.data?.message || 'Payment session failed')
    } finally {
      setLoading(false)
    }
  }
            ...
            <div className="bg-blue-50 border border-blue-100 
              ...
              <div>
                ...
                <p className="text-xs text-blue-600 mt-0.5">
                  You'll be redirected to Stripe to complete payment safely
                </p>
              </div>
            </div>
                  ...
                  {addresses.map(addr => (
                    ...
                    >
                      <p className="text-xs font-bold text-gray-700 
                        uppercase tracking-wide mb-1">{addr.name}</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium 
                    text-gray-700 mb-1.5">Street Address</label>
                ...
                <div>
                  <label className="block text-sm font-medium 
                    text-gray-700 mb-1.5">Phone Number</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-sm font-medium 
                    text-gray-700 mb-1.5">City</label>
                  <div className="relative">
